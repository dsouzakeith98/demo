...
float: left; 
 ...
 <div class="belnav">
      ...
      <div class="belnavc modal-button">Sign up</div>
...
<div class="topnav" id="myTopnav">
    ...
    <a href="cycle.php">Cycling</a>
    <a href="home1.php">Trekking</a>
    
  </div>
<div class="imagefit">
<img src="images/maincyc.jpeg">
 <div class="centered">Cycling&nbsp;&nbsp;&nbsp;</div>
 <div class="bottom-left">"Cyclers see considerably more of this beautiful world than any other class of citizens.<br>A good bicycle, well applied, will cure most ills this flesh is heir to"</div>
 <div class="bottom">Tip 2: If you are on a trekking trail for the first time, always walk in groups, avoid walking alone if you are not sure about the trail. </div>
</div>
<div class="filter">
  <div>
   <form id="app-cover">
  ...
  <div class="containerN">
     <label>Mangalore-BC Road</label><br><br>
     <figcaption style="font-size: 13px; float: left; font-style: bold;">Dakshina Kannada</figcaption>
     <img src="cycicon.png" style="float: left;">
     <figcaption style="font-size: 13px; float: left;">52</figcaption><br><br>
...
<div class="card">
  ...
  <div class="containerN">
     <label>Karwar-Gokarna</label><br><br>
     <figcaption style="font-size: 13px; float: left; font-style: bold;">Uttara Kannada</figcaption>
     <img src="cycicon.png" style="float: left;">
     <figcaption style="font-size: 13px; float: left;">32km</figcaption><br><br>
...
<div>
<div class="card">
  <img src="images/cyc3.jpg" alt="Avatar" style="width:100%; height: 186px;">
  <div class="containerN">
    <label>Karkala-Modibedri</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Dakshina Kannada</figcaption>
    <img src="cycicon.png" style="float: left; ">
    <figcaption style="font-size: 13px; float: left;">38km</figcaption><br><br>
    <div class="example_e">Moderate</div>
     <p>699/-</p> <br>
     <div class="example_f">
          <button>
...
<div class="card">
  ...
  <div class="containerN">
    <label></label>Mangalore-Ullal<br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Dakshina Kannada</figcaption>
    <img src="cycicon.png" style="float: left;">
...
<div class="card">
  ...
  <div class="containerN">
    <label>Mangalore Highway</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Mangalore</figcaption>
    <img src="cycicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left;">15km</figcaption><br><br>
...
<div class="card">
  ...
  <div class="containerN">
    <label>Honavar-Murdeshwar</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Uttara Kannda</figcaption>
    <img src="cycicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left; font-style: bold;">40km</figcaption><br><br>
    <div class="example_e">Difficult</div>
     <p>699/-</p><br>
       <div class="example_f">
          <button onclick="document.getElementById('id01').style.display='block'">
