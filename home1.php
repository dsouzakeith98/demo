...
<div class="filter">
  ...
  <div class="itemcontainer">
    ...
    <div class="item">
      ...
      <div class="card">
  <img src="images/sinn.jpg" alt="Avatar" style="width:100%">
  <div class="containerN">
     <label class="place">Kumara Parvatha</label><br><br>
     <figcaption style="font-size: 13px; float: left; font-style: bold;">Dharmastala</figcaption>
     <img src="hillicon.png" style="float: left;">
     <figcaption style="font-size: 13px; float: left;">3200ft</figcaption><br><br>
     <div class="example_e">Difficult</div>
    <p class="price">₹3699</p> <br>
    <div class="example_f" >
...
<div>
<div class="card">
  <img src="images/fire.jpg" alt="Avatar" style="width:100%">
  <div class="containerN">
     <label class="place">Tadiandmol</label><br><br>
     <figcaption style="font-size: 13px; float: left; font-style: bold;">Madikeri</figcaption>
     <img src="hillicon.png" style="float: left;">
     <figcaption style="font-size: 13px; float: left;">1200ft</figcaption><br><br>
     <div class="example_e">Moderate</div>
    <p class="price">₹1699</p> <br>
    <div class="example_f">
          <button class="modal-button">
              <span>Book Slot</span>
          </button>
...
<div>
<div class="card">
  <img src="images/image3.jpg" alt="Avatar" style="width:100%">
  <div class="containerN">
    <label class="place">Kodachadri</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Shivmoga</figcaption>
    <img src="hillicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left;">1200ft</figcaption><br><br>
    <div class="example_e">Moderate</div>
     <p class="price">₹1999</p> <br>
     <div class="example_f">
          <button class="modal-button">
              <span>Book Slot</span>
          </button>
  ...
  <div>  
<div class="card">
  <img src="images/image4.jpg" alt="Avatar" style="width:100%">
  <div class="containerN">
    <label class="place">Agumbe Trail</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Agumbe</figcaption>
    <img src="hillicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left;">1200ft</figcaption><br><br>
    <div class="example_e">Easy</div>
     <p class="price">₹1299</p> <br>
       <div class="example_f">
          <button  class="modal-button" >
              <span>Book Slot</span>
          </button>
...
<div class="card">
  ...
  <div class="containerN">
    <label class="place">Kudlu Falls</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Someshwar</figcaption>
    <img src="hillicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left;">1200ft</figcaption><br><br>
    <div class="example_e">Easy</div>
    <p class="price">₹999</p> <br>
      <div class="example_f">
          <button class="modal-button">
              <span>Book Slot</span>
          </button>
...
<div class="card">
  <img src="images/sinn.jpg" alt="Avatar" style="width:100%">
  <div class="containerN">
    <label class="place">Bandhaje Arbe</label><br><br>
    <figcaption style="font-size: 13px; float: left; font-style: bold;">Shivmoga</figcaption>
    <img src="hillicon.png" style="float: left;">
    <figcaption style="font-size: 13px; float: left; font-style: bold;">1200ft</figcaption><br><br>
    <div class="example_e">Difficult</div>
     <p class="price">₹2999</p><br>
       <div class="example_f">
          <button  class="modal-button">
              <span>Book Slot</span>
          </button>
