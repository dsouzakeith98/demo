...
<body>
 ...
 <div class="belnav">
  ...
  <div class="topnav" id="myTopnav">
    ...
    <a href="cyclingmain.html">Cycling</a>
...
<div class="modal2">
 ...
 <div class="input-block">
        <label for="uname" class="input2-label2">Full Name</label>
        <input type="textbox" name="uname" id="uname" placeholder="Full Name">
      </div>
  ...
  <button type="submit" class="submit" name="submit" value="submit" class="example_f modal2-button2">Login In</button>
 </div>
...
`
  const closeButton2 = document.querySelector(".close2-button2");
    ...
    const modalLeft2 = document.querySelector('.modal2-left2');
        ...
        xmlhttp.onreadystatechange = function() {
            if (this.readyState == 4 && this.status == 200) {
                ...
                if(/error/.test(this.responseText.toLowerCase())){
                  ...
                  errEl.innerHTML = `<br><small><b><font color="red";>Invalid User</font></b></small>`
        ...
        window.location.href = "demologin.php";
...
const closeButton2 = document.querySelector(".close2-button2");
const scrollDown = document.querySelector(".scroll2-down2");
